...
<body>
    <div class="wrapper">
        ...
        <form class="p-3 mt-3" method="POST">
            <button class="btn mt-3" name="btnupdate"><a href="signup.php?id=<?php echo $row[0]; ?>">Update</a></button>
        </form>
        <div class="text-center fs-6">
            <a href="forgot.php">Forget password?</a> or <a href="signup.php">Sign up</a>or <a href="home.php">Home page</a>
        </div>
    </div>
</body>
</html>